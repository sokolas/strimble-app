...
-- licensed under MIT (see http://lua-users.org/lists/lua-l/2014-08/msg00628.html)
...
local function finalresult256 (H, bin)
  -- Produce the final hash value (big-endian):
  if bin then
...
local function hash256 (msg, bin)
  msg = preproc(msg, #msg)
  local H = initH256(HH)
